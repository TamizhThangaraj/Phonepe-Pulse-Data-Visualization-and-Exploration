...
st.set_page_config(page_title='PHONEPE PULSE',page_icon=icon,initial_sidebar_state='expanded',
                        layout='wide',menu_items={"about":'This streamlit application was developed by T.Tamil mani'})
...
if selected == "ABOUT":
        ...
        st.markdown('''<h5>Hello! I'm Tamil mani, a BBA graduate with a keen interest in data science and analytics.
                Currently on an exciting journey into the world of data science...''',unsafe_allow_html=True)
        st.link_button('Linkedin','https://www.linkedin.com/in/tamil004/') 
...
if selected =="HOME":
        ...
        with col2:
                ...
                st.markdown('''
                        <h3>Transaction:<h5>Transaction insights involve analyzing customer transaction data to understand behavior and preferences.
